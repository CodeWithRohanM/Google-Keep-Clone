            ...
            <div id="actualNotePad" className="p-2 w-1/2 h-fit rounded-lg flex flex-col border border-gray-400">

                {
                    takingNote && <div className="w-full">
                        <input type="text" placeholder="Title" className="p-3 w-full" value={data.title} onChange={takeUserInput} name="title"></input>
                    </div>
                }
                ...
                <div className={`border border-gray-400 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 rounded-b-md ${roundedValue}`}>
                    <div className={`px-4 py-2 ${roundedValue} dark:bg-gray-800`}>
                        <textarea id="comment" rows="2" className="w-full text-sm text-gray-900 bg-gray-50 border-0 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400" placeholder="Write a note..." onClick={takingInput} value={data.note} onChange={takeUserInput} name="note"></textarea>
                    </div>
                    <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                        <button type="button" className="inline-flex items-center text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-bold rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 w-36" onClick={listItems}>
